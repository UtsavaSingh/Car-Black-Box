...
void main(void) {
    ...
    while (1) {
        ...
        else if((control_flag == 0x01) && (key == 0x37 || key == 0x2F))
        {
        ...
        else if((control_flag == 0x03) && (key_level == 0x37) && (delay1++ == 20))
        {
        ...
        else if((control_flag == 0x03) && (key_level == 0x2F) && (delay2++ == 20))
        {
        ...
        else if((control_flag == 0x04) && (key_level == 0x2F) && (delay3++ == 20))
        {
        ...
        else if((control_flag == 0x04) && (key_level == 0x37) && (delay4++ == 20))
        {
        ...
        else if((control_flag == 0x07) && (key_level == 0x37) && (delay5++ == 20))
        {
        ...
        switch(control_flag)
        {
            ...
            case 0x06 :
                ...
                TMR2ON = 0;
                if(download_log(reset_flag) == 0x22)
                {
                    control_flag = 0x03;
                    reset_flag = 0x11;
                    continue;
